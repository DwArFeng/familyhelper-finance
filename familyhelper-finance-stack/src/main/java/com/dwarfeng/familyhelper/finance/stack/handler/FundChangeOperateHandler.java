...
public interface FundChangeOperateHandler extends Handler {
     ...
     */
    LongIdKey recordFundChange(StringIdKey userKey, FundChangeRecordInfo fundChangeRecordInfo) throws HandlerException;
     ...
     * @throws HandlerException 处理器异常。
     */
    void updateFundChange(StringIdKey userKey, FundChangeUpdateInfo fundChangeUpdateInfo) throws HandlerException;
