...
public class ResetCommand extends CliCommand {
    ...
    private static final String COMMAND_OPTION_RESET_REMIND_DRIVE = "reset-remind-drive";
    ...
    private static final String[] COMMAND_OPTION_ARRAY = new String[]{
            ...
            COMMAND_OPTION_RESET_REMIND_DRIVE
    };
    ...
    private static final String CMD_LINE_SYNTAX_RESET_REMIND_DRIVE = IDENTITY + " " +
            CommandUtil.concatOptionPrefix(COMMAND_OPTION_RESET_REMIND_DRIVE);
    ...
    private static final String[] CMD_LINE_ARRAY = new String[]{
            ...
            CMD_LINE_SYNTAX_RESET_REMIND_DRIVE
    };
    ...
    protected List<Option> buildOptions() {
        ...
        list.add(Option.builder().longOpt(COMMAND_OPTION_RESET_REMIND_DRIVE).desc("执行重置操作").build());
        return list;
    }
        ...
        try {
            ...
            switch (pair.getLeft()) {
                ...
                case COMMAND_OPTION_STATUS:
                    printStatus(context);
                    break;
                case COMMAND_OPTION_RESET_REMIND_DRIVE:
                    resetQosService.resetRemindDrive();
