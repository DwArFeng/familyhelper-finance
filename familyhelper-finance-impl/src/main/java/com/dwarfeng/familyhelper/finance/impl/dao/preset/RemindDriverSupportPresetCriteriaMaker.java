...
@Component
public class RemindDriverSupportPresetCriteriaMaker implements PresetCriteriaMaker {

    @Override
    public void makeCriteria(DetachedCriteria detachedCriteria, String s, Object[] objects) {
        switch (s) {
            case RemindDriverSupportMaintainService.ID_LIKE:
                idLike(detachedCriteria, objects);
                break;
            case RemindDriverSupportMaintainService.LABEL_LIKE:
