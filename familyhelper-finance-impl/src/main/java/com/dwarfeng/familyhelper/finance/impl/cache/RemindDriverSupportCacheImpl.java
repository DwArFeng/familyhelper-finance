...
import com.dwarfeng.familyhelper.finance.stack.cache.RemindDriverSupportCache;
...
@Repository
public class RemindDriverSupportCacheImpl implements RemindDriverSupportCache {

    private final RedisBatchBaseCache<StringIdKey, RemindDriverSupport, FastJsonRemindDriverSupport> batchBaseCache;

    public RemindDriverSupportCacheImpl(
            RedisBatchBaseCache<StringIdKey, RemindDriverSupport, FastJsonRemindDriverSupport> batchBaseCache
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public RemindDriverSupport get(StringIdKey key) throws CacheException {
    ...
    public void push(RemindDriverSupport value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<RemindDriverSupport> batchGet(@SkipRecord List<StringIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<RemindDriverSupport> entities, long timeout) throws CacheException {
