...
public class HibernateBankCardTypeIndicator implements Bean {
    ...
    private static final long serialVersionUID = 7231561748814527116L;
    ...
    // -----------------------------------------------------------审计-----------------------------------------------------------
    @DatamarkField(handlerName = "indicatorDatamarkHandler")
    @Column(
    ...
    public HibernateBankCardTypeIndicator() {
    }
