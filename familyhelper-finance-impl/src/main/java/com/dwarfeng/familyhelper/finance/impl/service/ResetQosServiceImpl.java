...
import com.dwarfeng.familyhelper.finance.stack.handler.ResetHandler;
import com.dwarfeng.familyhelper.finance.stack.handler.Resetter;
import com.dwarfeng.familyhelper.finance.stack.handler.ResetterHandler;
...
public class ResetQosServiceImpl implements ResetQosService {
    ...
    @Override
    public void resetRemindDrive() throws ServiceException {
        try {
            resetHandler.resetRemindDrive();
        } catch (Exception e) {
            throw ServiceExceptionHelper.logAndThrow("重置提醒驱动时发生异常", LogLevel.WARN, sem, e);
        }
    }
}
