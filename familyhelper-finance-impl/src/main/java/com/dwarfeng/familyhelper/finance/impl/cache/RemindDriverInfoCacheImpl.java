...
import com.dwarfeng.familyhelper.finance.sdk.bean.entity.FastJsonRemindDriverInfo;
import com.dwarfeng.familyhelper.finance.stack.bean.entity.RemindDriverInfo;
import com.dwarfeng.familyhelper.finance.stack.cache.RemindDriverInfoCache;
...
@Repository
public class RemindDriverInfoCacheImpl implements RemindDriverInfoCache {

    private final RedisBatchBaseCache<LongIdKey, RemindDriverInfo, FastJsonRemindDriverInfo> batchBaseCache;

    public RemindDriverInfoCacheImpl(
            RedisBatchBaseCache<LongIdKey, RemindDriverInfo, FastJsonRemindDriverInfo> batchBaseCache
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public RemindDriverInfo get(LongIdKey key) throws CacheException {
    ...
    public void push(RemindDriverInfo value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<RemindDriverInfo> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<RemindDriverInfo> entities, long timeout) throws CacheException {
